...
from .signal_gates import compute_loss_tilt_override, apply_loss_tilt_pause, apply_scalp_hold_guard, apply_confidence_floor, apply_reward_risk_gate, format_gate_trace
...
__all__ = [
    ...
    "run_hybrid_bot",
    "compute_loss_tilt_override", "apply_loss_tilt_pause", "apply_scalp_hold_guard", "apply_confidence_floor", "apply_reward_risk_gate", "format_gate_trace",
